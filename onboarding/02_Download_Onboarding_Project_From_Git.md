...
1. Open **GitExtensions** (or any other Git client you're comfortable with) and click **Clone Repository**.
   ...
   ![GitExtensions main window with the Clone Repository button highlighted](../images/02_Download_Onboarding_Project_From_Git/image1.png)

   If you don't have GitExtensions installed, you can download it from <http://gitextensions.github.io/>.

   ![GitExtensions Clone repository dialog with repository URL, destination, and subdirectory fields](../images/02_Download_Onboarding_Project_From_Git/image2.png)
...
4. In **Solution Explorer**, expand **SixtyThreeBits.Web -> wwwroot** and check whether an **upload** folder exists. If it doesn't, create a new folder and name it **upload**.
   ...
   ![Solution Explorer showing the SixtyThreeBits.Web project's wwwroot folder structure](../images/02_Download_Onboarding_Project_From_Git/image3.png)

   ![wwwroot folder with the upload folder created](../images/02_Download_Onboarding_Project_From_Git/image4.png)
...
5. Open **Solution Explorer -> SixtyThreeBits.Web -> appsettings.json** and change the database name in the `DbConnectionString` to match your database name and connection string.
   ...
   ![appsettings.json file location in Solution Explorer](../images/02_Download_Onboarding_Project_From_Git/image5.png)

   ![DbConnectionString value in appsettings.json highlighting the database name to change](../images/02_Download_Onboarding_Project_From_Git/image6.png)
...
6. Open **Solution Explorer -> SixtyThreeBits.Web -> Properties -> launchSettings.json** and make sure it matches the JSON below. If it doesn't, overwrite its contents with the JSON below.
   ...
   ![launchSettings.json file location in Solution Explorer](../images/02_Download_Onboarding_Project_From_Git/image7.png)
...
7. In **Solution Explorer**, right-click the **SixtyThreeBits.Onboarding** solution and click **Rebuild Solution**.
   ...
   ![Solution Explorer context menu with Rebuild Solution option](../images/02_Download_Onboarding_Project_From_Git/image8.png)

   A success message should appear in the Output window once the build completes.

   ![Output window showing a successful build message](../images/02_Download_Onboarding_Project_From_Git/image9.png)
...
8. Press **CTRL + F5** to run the project. Visual Studio will launch the project and open it in your browser. You should see the following:
   ...
   ![Onboarding project running in the browser](../images/02_Download_Onboarding_Project_From_Git/image10.png)
