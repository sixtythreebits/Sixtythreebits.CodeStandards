...
![Example of a bit column named with the Is prefix](./images/image1.png)

![Example query filtering on a bit column](./images/image2.png)
...
![Products table referencing CategoryID as its foreign key](./images/image3.png)

![SSMS table design showing the CategoryID foreign key column](./images/image4.png)
...
![ProductsRelated table with ProductIDTarget and ProductIDRelated columns](./images/image5.png)
...
![Default SQL Server-generated foreign key names before renaming](./images/image6.png)
...
![Foreign key renamed to FK_ProductsRelated_Products_ProductIDTarget](./images/image7.png)
...
![Primary key Identity Specification set to Yes with an Identity Seed of 1](./images/image8.png)
...
![ProductDateCreated column configured as datetime, not nullable, defaulting to GETDATE()](./images/image9.png)
...
![Stored procedures and functions grouped alphabetically by table name in SSMS](./images/image10.png)
...
![ConstantsNullValueForNumeric, ConstantsNullValueForDate, and ConstantsNullValueForString functions](./images/image11.png)
