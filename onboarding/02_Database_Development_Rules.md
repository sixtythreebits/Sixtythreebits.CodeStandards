...
![Example of a bit column named with the Is prefix](../images/02_Database_Development_Rules/image1.png)

![Example query filtering on a bit column](../images/02_Database_Development_Rules/image2.png)
...
![Products table referencing CategoryID as its foreign key](../images/02_Database_Development_Rules/image3.png)

![SSMS table design showing the CategoryID foreign key column](../images/02_Database_Development_Rules/image4.png)
...
![ProductsRelated table with ProductIDTarget and ProductIDRelated columns](../images/02_Database_Development_Rules/image5.png)
...
![Default SQL Server-generated foreign key names before renaming](../images/02_Database_Development_Rules/image6.png)
...
![Foreign key renamed to FK_ProductsRelated_Products_ProductIDTarget](../images/02_Database_Development_Rules/image7.png)
...
![Primary key Identity Specification set to Yes with an Identity Seed of 1](../images/02_Database_Development_Rules/image8.png)
...
![ProductDateCreated column configured as datetime, not nullable, defaulting to GETDATE()](../images/02_Database_Development_Rules/image9.png)
...
![Stored procedures and functions grouped alphabetically by table name in SSMS](../images/02_Database_Development_Rules/image10.png)
...
![ConstantsNullValueForNumeric, ConstantsNullValueForDate, and ConstantsNullValueForString functions](../images/02_Database_Development_Rules/image11.png)
