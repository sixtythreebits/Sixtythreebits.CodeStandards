...
![Right-click Tables > New > Table in SSMS Object Explorer](../images/01_Database_Development_Rules_Todo_02/image1.png)

<br><br>

**Products**

![Products table designer with ProductID column set as Identity Specification Yes, Identity Seed 1](../images/01_Database_Development_Rules_Todo_02/image2.png)

![Products table designer with ProductDateCreated column set to datetime, not nullable, defaulting to (getdate())](../images/01_Database_Development_Rules_Todo_02/image3.png)

<br><br>

**ProductsImages**

![ProductsImages table designer with ProductImageID column set as Identity Specification Yes, Identity Seed 1](../images/01_Database_Development_Rules_Todo_02/image4.png)

![ProductsImages table designer with ProductImageDateCreated column set to datetime, not nullable, defaulting to (getdate())](../images/01_Database_Development_Rules_Todo_02/image5.png)

<br>

Create PK – FK relationship between two tables, set UPDATE CASCADE and DELETE CASCADE.

![Foreign Key Relationships dialog for FK_ProductsImages_Products with Delete Rule and Update Rule set to Cascade](../images/01_Database_Development_Rules_Todo_02/image6.png)

<br><br>

**Categories**

![Categories table designer with CategoryID column set as Identity Specification Yes, Identity Seed 1](../images/01_Database_Development_Rules_Todo_02/image7.png)

![Categories table designer with CategoryDateCreated column defaulting to (getdate())](../images/01_Database_Development_Rules_Todo_02/image8.png)
...
![Foreign Key Relationships dialog for FK_Products_Categories with Delete Rule and Update Rule set to No Action](../images/01_Database_Development_Rules_Todo_02/image9.png)
...
![Right-click Stored Procedures > New > Stored Procedure in SSMS Object Explorer](../images/01_Database_Development_Rules_Todo_02/image10.png)
...
![Completed ProductsIUD stored procedure script implementing INSERT, UPDATE, and DELETE logic with TRY/CATCH error handling](../images/01_Database_Development_Rules_Todo_02/image11.png)
...
![Right-click Functions > Table-valued Functions > New Inline Table-valued Function in SSMS Object Explorer](../images/01_Database_Development_Rules_Todo_02/image12.png)

Implement stored procedure according to screenshot below, <u>do not copy and paste code from previous document</u>:

![Completed ProductsList inline table-valued function script](../images/01_Database_Development_Rules_Todo_02/image13.png)
...
![Right-click Functions > Scalar-valued Functions > New Scalar-valued Function in SSMS Object Explorer](../images/01_Database_Development_Rules_Todo_02/image14.png)
...
![Completed ProductsGetSingleByID scalar-valued function script returning product data with its category and images as JSON](../images/01_Database_Development_Rules_Todo_02/image15.png)
